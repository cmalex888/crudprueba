    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (accion.equals("Insertar")){
                ...
                objproveedor.setIdProv(idProv);
                objproveedor.setNombreProv(nombreProv);
                objproveedor.setDirProv(dirProv);
                objproveedor.setTelProv(telProv);
                objproveedor.setEmailProv(emailProv);
